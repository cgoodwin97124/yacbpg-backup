...
- **The version-history entries now render their formatting** (`**bold**` and `code` spans) instead of printing the raw asterisks and backticks — this file has always used that Markdown, and the About panel used to show it literally.
