...
- **Status:** 🟢 **START NOW 2026-09-25** — the author asked for it directly ("I'd like to have a checkbox…"), so work started on receipt; logged here first, per the standing rule.
